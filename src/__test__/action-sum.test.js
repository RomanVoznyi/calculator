...
it("check sum operation without arguments", () => {
  action("+", { ...state });
...
it("check sum operation with inputNumb and without expression", () => {
